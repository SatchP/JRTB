...
public class RestClientExample {
    ...
    @Value( "${NRD.NSD_DATA_HOST}" )
    private static String NSD_DATA_HOST;

    @Value( "${NRD.METHOD_NAME}" )
    private static String METHOD_NAME;

    @Value( "${NRD.RESULT_EXCEL_PATH}" )
    private static String RESULT_EXCEL_PATH;

   // private static final String NSD_DATA_HOST = "http://nsddata.ru/api/get";
  //  private static final String METHOD_NAME = "valuationnew";
  //  private static final String RESULT_EXCEL_PATH = "C:/Temp/securities100.xls";

    public static void main(String[] args) { saveExcel(getFirstHundredSecurities()); }
    ...
    private static HSSFWorkbook generateExcel(JSONArray securities) {
        ...
        headRow.createCell(2).setCellValue("nsd_code");
        headRow.createCell(3).setCellValue("price");
        ...
        for (Object obj : securities) {
            ...
            row.createCell(2).setCellValue( json.optString("nsd_code"));
            row.createCell(3).setCellValue( json.optString("price"));
        }
